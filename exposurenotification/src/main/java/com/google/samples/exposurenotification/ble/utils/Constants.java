...
public class Constants {
    ...
    public static final ParcelUuid CONTACT_TRACER_UUID =
            new ParcelUuid(to128BitUuid((short) 0xFD77));
    private static final int BIT_INDEX_OF_16_BIT_UUID = 32;

    // whether to switch to GAENPLUS (using location)
    public static boolean GAENPLUS = true;
